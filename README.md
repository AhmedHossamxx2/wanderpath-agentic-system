...
**Top-level decomposition: rebooking a disrupted multi-leg itinerary (locked 20-case test suite)**

| Method | Task Success | Avg. LLM Calls | Avg. Tokens | Avg. Latency | Est. Cost/Run |
|---|---|---|---|---|---|
| Decomposition-first | *[fill from `planning_eval/comparison_table.md`]* | | | | |
| **Dynamic decomposition** | *[fill]* | | | | |
...
|---|---|---|---|---|---|
| Plan-and-Solve | *[fill]* | | | | |
| Tree of Thoughts | *[fill]* | | | | |
| LATS, ungrounded env. (toolkit default) | *[fill]* | | | | |
| LATS, grounded env. (real entry/cancellation validator) | *[fill]* | | | | |

**Self-correction comparison**

| Method | Success after N trials | Avg. LLM Calls | Avg. Tokens | Avg. Latency | Est. Cost/Run |
|---|---|---|---|---|---|
| Self-Refine (1 revision) | *[fill]* | | | | |
| Reflexion (capped episodic buffer) | *[fill]* | | | | |
...
└── planning_eval/                   # Decomposition & Planning Evaluation
    ...
    ├── run_eval.py                  # Runs every method against every applicable case
    ├── comparison_table.md          # Generated, CI-verified comparison table (embedded in §8.C)
    └── artifacts/                   # Per-run JSON traces (plans, critic feedback, MCTS visits, reflections)
```
